...
namespace JR.Models
{
    ...
    /// 调拨申请单表头实体类
    /// </summary>
    public class EntityST_AppTransVouch : BaseEntity
    {
        /// <summary>
        /// 单据号
        /// </summary>
        ...
        public IList<EntityST_AppTransVouchBody> Details { get; set; }
    ...
    /// 调拨申请单表体实体类
    /// </summary>
    public class EntityST_AppTransVouchBody:BaseEntity
    {
        /// <summary>
        /// 存货编码
        /// </summary>
        ...
        /// 申请数量
        /// </summary>
        [EntityCheck(Name = "申请数量", IsMust = true)]
